...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <link rel="shortcut icon" href="http://shared.ydstatic.com/images/favicon.ico" type="image/x-icon" />
           <link href="http://shared.ydstatic.com/fanyi/newweb/v1.0.6/styles/newweb/fanyi-newweb.min.css" rel="stylesheet" type="text/css"/>
...
<ul class="fanyi__nav__list">
    <li><a target="_blank" href="http://egg.youdao.com/?keyfrom=fanyi-new-nav">有道翻译蛋</a></li>
    ...
    <li><a target="_blank" href="http://fanyiguan.youdao.com/?vendor=fanyi-new-nav">翻译APP</a></li>
            <li class="last">
                        <a class="login-link" href="http://f.youdao.com/login.do?back_url=">登录</a>
                    </li>
    </ul>
    ...
    <div class="fanyi">
        ...
        <div class="inside__products">
            ...
            <div class="inside__products__item">
                <a target="_blank" href="http://egg.youdao.com/?keyfrom=fanyi-new-bottom">
    ...
    <div class="side__nav">
        ...
        <a target="_blank" href="http://survey2.163.com/html/fanyis201103a2/paper.html?id=1714997051@10.168.8.61@0" class="side__nav__feedback">满意度<br/>反馈</a>
